...
const TRAINING_VIDEOS = [
  ...
  { id: "IIjpinPyz2w", title: "Strategic Evaluation & Planning (The Funnel)", handout: "/docs/strategic-evaluation-planning-the-funnel.pdf", body: "In this video, Andrew Estes and Phil Claycomb discuss the assimilation funnel as a strategic tool for church growth and community engagement. They emphasize the importance of evaluating current practices, identifying strengths and weaknesses, and planning actionable steps to align with the church's vision. This video offers insights on how to effectively train and deploy individuals on mission, as well as the importance of foreground initiatives in achieving long-term goals." },
  { id: "qrcyk2my2bE", title: "Branding & Marketing", handout: "/docs/branding-marketing.pdf", handoutLabel: "CLICK HERE to download the session handout for this session.", body: "In this video, Andrew Estes discusses the intersection of marketing and ministry within the church context. He emphasizes that marketing should not be viewed as self-promotion but as a means to clarify the church's mission and facilitate life transformation. The discussion covers the importance of branding, digital presence, effective website design, social media engagement, the power of photography, and the significance of reviews in building trust. Estes concludes by stressing the need for systematic approaches to church growth rather than sporadic efforts, reinforcing that marketing, when done with humility, can serve as a form of hospitality." },
  { id: "XqxP1uw7C9M", title: "Why Our Churches Struggle to Reach People Today: Understanding The E Scale", body: "In this church planting training session, we explore an important reality. It is possible to successfully launch a church that is misaligned with the community, the culture, or even the calling of the planter. Many leaders unintentionally reproduce the church culture they came from rather than rethinking how to engage people who are drifting further away from traditional expressions of church." },
  { id: "cDDWvj_q-o8", title: "Cleveland Clinic Case Study: Empathy", body: "The Cleveland Clinic Case Study has been a staple for Nexus' training. It's a great reminder to never assume and always see people the way God sees them. For the Cleveland Clinic, patient care is more than just healing -- it's building a connection that encompasses mind, body, and soul. If you could stand in someone else's shoes . . . hear what they hear. See what they see. Feel what they feel. Would you treat them differently?" },
];
...
const TESTIMONY_VIDEOS = [
  ...
  { id: "3UIHq-s5v6g", title: "Unexpected Challenges", body: "Planting a church is hard work. Not to mention, your Enemy doesn't want you to succeed. In this video, planters share their experience of overcoming unexpected challenges in planting." },
];
...
const PODCASTS = [
  ...
  { title: "The Craig Groeschel Leadership Podcast", body: "The Craig Groeschel Leadership Podcast offers personal, practical coaching lessons that take the mystery out of leadership.", href: "https://www.life.church/leadershippodcast/" },
  ...
  { title: "New Churches Q&A Podcast", body: "The New Churches podcast offers practical answers to your real ministry questions.", image: "/img/New-Churches-QA-Podcast__mediumsquare__.webp" },
  ...
  { title: "The Practical Church Planting Podcast", body: "Practical church planting exists to give you practical tips, advice and encouragement when it comes to planting and growing healthy churches.", image: "/img/The-Practical-Church-Planting-Podcast__mediumsquare__.webp" },
];
