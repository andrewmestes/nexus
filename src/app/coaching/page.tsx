...
export default function CoachingPage() {
  return (
    <>
      <PageHero
        eyebrow="Coaching"
        title="Coaching to Help Pastors and Leaders Excel in Their Ministry"
        subtitle="Our coaches guide you through the highs and lows of launching a life-giving, multiplying church."
      />
      ...
      <Section>
        ...
        <p className="mx-auto mt-4 max-w-2xl text-center text-primary">
          ...
          coaches can help. As church planters themselves, they bring
          experience and guidance, asking the right questions as they guide you
          through the art of church planting.
        </p>
      ...
      <Section tone="secondary">
        <SectionHeading>Meet Our Coaches</SectionHeading>
        <div className="mt-10">
      ...
      <Section>
        <SectionHeading>Coaching Through Every Stage</SectionHeading>
        <div className="mt-10">
          <CardGrid cols={3}>
            <Card
              eyebrow="0-2 Years"
      ...
      <NextStepsBand
        heading="See the Vision God Placed in Your Heart Come to Life"
        sub="No matter where you're at in your journey, our coaches are here to help you stay focused, encouraging you to plant the life-giving church of your dreams."
      />
